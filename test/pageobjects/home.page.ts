...
class HomePage extends BasePage {
  ...
  get welcomeHeader(): ReturnType<typeof $>  { return $('~welcome_header'); }
  get profileButton(): ReturnType<typeof $>  { return $('~profile_button'); }
  get settingsButton(): ReturnType<typeof $> { return $('~settings_button'); }
  get logoutButton(): ReturnType<typeof $>   { return $('~logout_button'); }
  get searchBar(): ReturnType<typeof $>      { return $('~search_bar'); }
